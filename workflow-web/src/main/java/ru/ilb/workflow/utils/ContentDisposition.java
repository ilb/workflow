...
/**
 * Кроссбраузерная отдавалка файлов.
 * Умеет передать имя скачиваемого файла по-русски, с пробелами и пр.
 * Поддерживает работу с mod_xsendfile.
 * Тестирован с Mozilla-ми, Opera, IE, Chrome, Safari.
 *
