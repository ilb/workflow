...
class ExternalReference extends \Happymeal\Port\Adaptor\Data\XML\Schema\AnyComplexType {
    ...
    protected function attributesToXmlWriter(\XMLWriter &$xw, $xmlname = self::ROOT, $xmlns = self::NS) {
        ...
        if ($prop = $this->getXref())
            $xw->writeAttribute('xref', $prop);
        if ($prop = $this->getLocation())
            $xw->writeAttribute('location', $prop);
        if ($prop = $this->getxNamespace())
            $xw->writeAttribute('namespace', $prop);
    }
