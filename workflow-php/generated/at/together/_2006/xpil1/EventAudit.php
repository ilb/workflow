	...
	class EventAudit extends \Happymeal\Port\Adaptor\Data\XML\Schema\AnyComplexType {
		...
		*/
		protected function attributesToXmlWriter ( \XMLWriter &$xw, $xmlname = self::ROOT, $xmlns = self::NS ) {
			...
			if( $prop = $this->getWorkflowProcessFactoryId() ) $xw->writeAttribute( 'WorkflowProcessFactoryId', $prop );
			if( $prop = $this->getWorkflowProcessFactoryVersion() ) $xw->writeAttribute( 'WorkflowProcessFactoryVersion', $prop );
			if( $prop = $this->getWorkflowProcessInstanceId() ) $xw->writeAttribute( 'WorkflowProcessInstanceId', $prop );
			if( $prop = $this->getWorkflowProcessInstanceName() ) $xw->writeAttribute( 'WorkflowProcessInstanceName', $prop );
			if( $prop = $this->getActivityInstanceId() ) $xw->writeAttribute( 'ActivityInstanceId', $prop );
			if( $prop = $this->getActivityInstanceName() ) $xw->writeAttribute( 'ActivityInstanceName', $prop );
			if( $prop = $this->getPackageId() ) $xw->writeAttribute( 'PackageId', $prop );
			if( $prop = $this->getProcessDefinitionId() ) $xw->writeAttribute( 'ProcessDefinitionId', $prop );
			if( $prop = $this->getActivityDefinitionId() ) $xw->writeAttribute( 'ActivityDefinitionId', $prop );
		}
		/**
