<?php
	...
	class InstanceExtendedAttribute extends \Happymeal\Port\Adaptor\Data\XML\Schema\AnyComplexType {
			
		const NS = "http://www.together.at/2006/XPIL1.0";
		const ROOT = "InstanceExtendedAttribute";
		const PREF = NULL;
		/**
		 * @maxOccurs 1 
		 * @var \String
		...
		*/
		protected function attributesToXmlWriter ( \XMLWriter &$xw, $xmlname = self::ROOT, $xmlns = self::NS ) {
			...
			if( $prop = $this->getValue() ) $xw->writeAttribute( 'Value', $prop );
		}
		/**
